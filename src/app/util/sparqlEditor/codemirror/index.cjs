...
var highlight$1 = require('@lezer/highlight');
...
const highlight =highlight$1.styleTags({
        Comment: highlight$1.tags.comment,
        "BASE PREFIX SELECT CONSTRUCT DESCRIBE WHERE DISTINCT REDUCED STR LANG LANGMATCHES DATATYPE ASK BOUND IRI URI BNODE RAND ABS CEIL FLOOR ROUND CONCAT STRLEN UCASE LCASE ENCODE_FOR_URI CONTAINS STRSTARTS STRENDS STRBEFORE STRAFTER YEAR MONTH DAY HOURS MINUTES SECONDS TIMEZONE TZ NOW UUID STRUUID MD5 SHA1 SHA256 SHA384 SHA512 COALESCE IF STRLANG STRDT SAMETERM ISIRI ISURI ISBLANK ISLITERAL ISNUMERIC COUNT SUM MIN MAX AVG SAMPLE GROUP_CONCAT SEPARATOR SUBSTR REPLACE REGEX EXISTS NOT IN GROUP BY HAVING ORDER ASC DESC LIMIT OFFSET VALUES UNDEF UNION OPTIONAL MINUS GRAPH SERVICE SILENT FILTER BIND AS FROM NAMED LOAD INTO TO CLEAR DROP CREATE ADD MOVE COPY INSERT DATA DELETE WITH DEFAULT ALL USING SIMILARITY JOIN ON TOP WITHIN DISTANCE CLUSTER": highlight$1.tags.keyword,
        "Var ObjectListPath/..": highlight$1.tags.variableName,
        String: highlight$1.tags.string,
        Integer: highlight$1.tags.integer,
        "Double Decimal": highlight$1.tags.float,
        "{ }": highlight$1.tags.brace,
        Langstag: highlight$1.tags.annotation,
        "TRUE FALSE": highlight$1.tags.bool,
				"VerbPath Namespace IriRef": highlight$1.tags.namespace,
				"Iri": highlight$1.tags.url,
				"RDFLiteral/Iri": highlight$1.tags.typeName,
      });
language.syntaxHighlighting(
  language.HighlightStyle.define(
    [
  { tag: highlight$1.tags.keyword, color: base_purple },
  {
    tag: [highlight$1.tags.name, highlight$1.tags.deleted, highlight$1.tags.character, highlight$1.tags.macroName],
    color: base_cyan
  },
  { tag: [highlight$1.tags.propertyName], color: base_yellow },
  { tag: [highlight$1.tags.variableName], color: base05 },
  { tag: [highlight$1.tags.function(highlight$1.tags.variableName)], color: base_cyan },
  { tag: [highlight$1.tags.labelName], color: base_purple },
  {
    tag: [highlight$1.tags.color, highlight$1.tags.constant(highlight$1.tags.name), highlight$1.tags.standard(highlight$1.tags.name)],
    color: base_yellow
  },
  { tag: [highlight$1.tags.definition(highlight$1.tags.name), highlight$1.tags.separator], color: base_pink },
  { tag: [highlight$1.tags.brace], color: base_purple },
  {
    tag: [highlight$1.tags.annotation],
    color: invalid
  },
  {
    tag: [highlight$1.tags.number, highlight$1.tags.changed, highlight$1.tags.annotation, highlight$1.tags.modifier, highlight$1.tags.self, highlight$1.tags.namespace],
    color: base_orange
  },
  {
    tag: [highlight$1.tags.typeName, highlight$1.tags.className],
    color: base_orange
  },
  {
    tag: [highlight$1.tags.operator, highlight$1.tags.operatorKeyword],
    color: base_indigo
  },
  {
    tag: [highlight$1.tags.tagName],
    color: base_deeporange
  },
  {
    tag: [highlight$1.tags.squareBracket],
    color: base_red
  },
  {
    tag: [highlight$1.tags.angleBracket],
    color: base02
  },
  {
    tag: [highlight$1.tags.attributeName],
    color: base05
  },
  {
    tag: [highlight$1.tags.regexp],
    color: invalid
  },
  {
    tag: [highlight$1.tags.quote],
    color: base_green
  },
  { tag: [highlight$1.tags.string], color: base_lightgreen },
  {
    tag: highlight$1.tags.link,
    color: base_cyan,
    textDecoration: 'underline',
    textUnderlinePosition: 'under'
  },
  {
    tag: [highlight$1.tags.url, highlight$1.tags.escape, highlight$1.tags.special(highlight$1.tags.string)],
    color: base_yellow
  },
  { tag: [highlight$1.tags.meta], color: base03 },
  { tag: [highlight$1.tags.comment], color: base03, fontStyle: 'italic' },
  { tag: highlight$1.tags.monospace, color: base05 },
  { tag: highlight$1.tags.strong, fontWeight: 'bold', color: base_red },
  { tag: highlight$1.tags.emphasis, fontStyle: 'italic', color: base_lightgreen },
  { tag: highlight$1.tags.strikethrough, textDecoration: 'line-through' },
  { tag: highlight$1.tags.heading, fontWeight: 'bold', color: base_yellow },
  { tag: highlight$1.tags.heading1, fontWeight: 'bold', color: base_yellow },
  {
    tag: [highlight$1.tags.heading2, highlight$1.tags.heading3, highlight$1.tags.heading4],
    fontWeight: 'bold',
    color: base_yellow
  },
  {
    tag: [highlight$1.tags.heading5, highlight$1.tags.heading6],
    color: base_yellow
  },
  { tag: [highlight$1.tags.atom, highlight$1.tags.bool, highlight$1.tags.special(highlight$1.tags.variableName)], color: base_cyan },
  {
    tag: [highlight$1.tags.processingInstruction, highlight$1.tags.inserted],
    color: base_red
  },
  {
    tag: [highlight$1.tags.contentSeparator],
    color: base_cyan
  },
  { tag: highlight$1.tags.invalid, color: base02, borderBottom: `1px dotted ${base_red}` }
],
    { all: { color: "#585858" } }
  )
);
...
const SparqlLanguage = language.LRLanguage.define({
    parser: parser.configure({
        props: [
            highlight$1.styleTags({
                Comment: highlight$1.tags.comment,
                "BASE PREFIX SELECT CONSTRUCT DESCRIBE WHERE DISTINCT REDUCED STR LANG LANGMATCHES DATATYPE ASK BOUND IRI URI BNODE RAND ABS CEIL FLOOR ROUND CONCAT STRLEN UCASE LCASE ENCODE_FOR_URI CONTAINS STRSTARTS STRENDS STRBEFORE STRAFTER YEAR MONTH DAY HOURS MINUTES SECONDS TIMEZONE TZ NOW UUID STRUUID MD5 SHA1 SHA256 SHA384 SHA512 COALESCE IF STRLANG STRDT SAMETERM ISIRI ISURI ISBLANK ISLITERAL ISNUMERIC COUNT SUM MIN MAX AVG SAMPLE GROUP_CONCAT SEPARATOR SUBSTR REPLACE REGEX EXISTS NOT IN GROUP BY HAVING ORDER ASC DESC LIMIT OFFSET VALUES UNDEF UNION OPTIONAL MINUS GRAPH SERVICE SILENT FILTER BIND AS FROM NAMED LOAD INTO TO CLEAR DROP CREATE ADD MOVE COPY INSERT DATA DELETE WITH DEFAULT ALL USING SIMILARITY JOIN ON TOP WITHIN DISTANCE CLUSTER": highlight$1.tags.keyword,
                "Var ObjectListPath/..": highlight$1.tags.variableName,
                String: highlight$1.tags.string,
            ...
            language.foldNodeProp.add({
                GroupGraphPattern: language.foldInside,
                QuadData: language.foldInside,
...
function sparql() {
    return new language.LanguageSupport(SparqlLanguage);
}

exports.SparqlLanguage = SparqlLanguage;
